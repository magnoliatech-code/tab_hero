# Product Guide - Tab Hero

## Initial Concept
I want to create a chrome extension to help me manage apps. 
This extension have all the functionality of tab manager plus, you can look at https://chromewebstore.google.com/detail/tab-manager-plus-for-chro/cnkdjjdmfiffagllbiiilooaoofcoeff?hl=en
In addition, it maintains a stack of tabs visited by the user, so the user can jump back and forward between tabs last visited.
I want the ui to be modern and sleek.
...
A modern, sleek, and minimalist interface featuring plenty of white space and subtle animations to ensure a clutter-free and professional management experience.
